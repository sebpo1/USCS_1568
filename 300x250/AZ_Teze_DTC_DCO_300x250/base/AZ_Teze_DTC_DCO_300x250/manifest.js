FT.manifest({
    ...
    "instantAds": [
        ...
        { "name": "F2headlineTxt_size_hex_xy",
            "type": "text",
            "default": "KEEP YOU FROM LIVING<br/>YOUR KIND OF LIFE|20|#003863|80,40"
        },
        { "name": "F3headlineTxt_size_hex_xy",
            "type": "text",
            "default": "Tezspire is the first and only<br/> treatment for <span class='pink'>severe asthma</span><br/>that provides control across<br/> every type of asthma.|14|#003863|100,50"
        },
        { "name": "F4headlineTxt_size_hex_xy",
            "type": "text",
            "default": "Learn how tezspire can help you<br/>live your kind of life, every day.|13|#003863|119,53"
        },
        { "name": "F4_legal_Txt_size_hex_xy",
            "type": "text",
            "default": "Tezspire is an add-on maintenance treatment for people aged 12<br/> and older with severe asthma. TEZSPIRE is not a rescue medication.|9|#003863|32,121"
        },
        { "name": "ISI_txt",
            "type": "text",
        ...
        { "name": "cta_txt_size_hex_xy",
            "type": "text",
            "default": "Lets get started|13|#fff|169,89"
        },
        { "name": "clickTag1_url",
            "type": "text",
            "default": ""
        ...
        { "name": "logo_img",
            "type": "image",
            "default": "images/logo_300x250.png"
        },
        { "name": "background_img",
            "type": "image",
