FT.manifest({
    ...
    "instantAds": [
        { "name": "main_rl",
            "type": "richload",
            "default": "AZ_Teze_DTC_DCO_300x250_rl"
        },
        ...
        { "name": "ISI_txt",
            ...
            <p><span class="bold">TEZSPIRE may cause serious side effects, including:</span>
                <ul class='class-ul'>
                    <li><span class='bold'>severe allergic (hypersensitivity) reactions, such as <br/> 
                    rash or eye allergy.</span> Call your healthcare provider or<br/>
                    get emergency help right away if you have any of<br/>
                    the following symptoms of an allergic reaction:
                    </li>
                </ul>
                </p>
             <ul type="circle" class='mrl-17'>
             <li>rash</li>
             ...
             <p class='bold'>Please see full <span id="prescribeisi">Prescribing Information</span>, including <span id="pi">Patient Information</span></p> 
             <p class='itaic bold'>You may report side effects related to AstraZeneca<br/>products by clicking <a id="here">here</a>. The Spanish version of the<br/>adverse event reporting language is also available<br/>at this site.
             </p>
             <p>
        ...
        { "name": "logo_img",
            "type": "image",
            "default": "images/Teze_DTC_DCO_logo_300x250.png"
        },
        { "name": "background_img",
            "type": "image",
